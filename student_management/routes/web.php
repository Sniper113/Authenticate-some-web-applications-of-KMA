...
Route::group(['prefix' => '/admin/user'], function () {
    ...
    Route::get('/sinhvien', 'SchoolManager@showStudent')->name('showStudent');

    Route::get('/teacher', 'SchoolManager@showTeacher')->name('showTeacher');

    Route::get('/course', 'SchoolManager@showCourse')->name('showCourse');

    Route::get('/point','PointController@index')->name('showPoint');
});
